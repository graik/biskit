...
def getOpCodes( seq_1, seq_2 ):
    ...
    seq_1, seq_2 - [ str ], list of single letters
...
def repeateInMatch( deletedRes ):
    ...
    deletedRes - string of one letter amino acid sequence
    
    example: 'GSGS'     returns  'GS'
...
def delete( seqAA, seqNr, delList ):
    ...
    seqAA   -  list with the amino acid sequence in one letter code 
    seqNr   -  list with the amino acid postitons
    delList -  list of residues to be deleted (postiton, length)

    example:  seqAA - ['A','G','R','T',.....]
              seqNr - [ 0,  1,  2,  3 ,.....]  
              delList - [(0, 2), (180, 4)]
