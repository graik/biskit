...
"""
Comments from Raik:
* Style: I converted this file to space-only indentation
* Style: I always try to stay within 80 columns ...

* overriding internal parameters -- that k2 is modified by calcK2 is logical but
  if I give an explicit kappa2 to another method I
  would expect that is only used for this method and does not override the
  internal k2. It's easy to get surprising results otherwise.

Remaining comments start with ** in the code/docstrings
"""
...
class FRET:
    ...
    Methods of this class can be used independently or in a pipeline 
    fashion (for instance calling first calcK2,
    ...
    def __init__(self, overlap, qyD,kappa2 = 2./3, tauA = 0., tauD =1., 
                 tauDA = 0., refr_index=None):
        """
        Initializes the FRET instance with some mandatory parameters for 
        analytic results and then some optional experimental values.

        **please document units!**
    ...
    def energyTransferRate(self, r):
        ...
        **please document units!**
        ...
        @param r: Distance (A) between those molecules. Note that r is a scalar, 
                  not a vector.
        @type r: float
    ...
    def energyTransferEfficiency(self , r, kappa2 = None):
        ...
        **please document units!**
        ...
        @param r: Distance (A) between those molecules. Note that r is a scalar, 
                  not a vector.
        @type r: float
        @param kappa2: Orientation factor for the chromophores. If this value is 
                       provided it overrides the last calculated one. 
        @type kappa2: float
    ...
    def calcK2( self, donor, acceptor, distance):
        ...
        Calculates the orientation factor of two chromophores. It overwrites the 
        last value in FRET.k2 .
        ...
        @param distance: Distance from the start of one chromophore dipole to 
                         the start of the dipole moment of the other chromophore.
    ...
    def calcR0 (self ): 
        """
        Calculates R0 (Forster distance) for the pair of chromophores defined 
        in the FRET instance.
