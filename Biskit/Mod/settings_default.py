...
Defines the options exported by L{Mod.settings} and provides fall-back
...
fields of Biskit.Mod.settings. Mod.settings.py is importing the content
...
Each parameter is defined by a tuple containing
  1. the default value for a parameter of this name in L{Mod.settings}
